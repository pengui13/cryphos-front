...
export default function EmaSettings({
  ...
  }, [selectedTimeframes, period, setSettings]);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-lg font-semibold text-white">EMA</h3>
      ...
      >
        ...
        <div>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-5">
            ...
            <p className="mt-3 text-xs text-white/40">
              20 is a common default for trend smoothing
            </p>
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-4">
          <div className="mb-2 text-sm font-medium text-white/80">Preview</div>
          <div className="text-xs text-white/50">
            EMA({period}) on{" "}
            <span className="text-white/70">
              {selectedTimeframes.join(", ")}
            </span>{" "}
            {selectedTimeframes.length === 1 ? "timeframe" : "timeframes"}
          </div>
        </div>
      </div>
    </div>
